    ...
    <div class="message-item" :class="message.type">
        ...
        <div v-else-if="message.type === 'bot' || message.type === 'assistant'" class="message-group">
            <div class="message-content bot-message">
                <van-image :src="message.avatar || botAvatar" round width="32" height="32" class="message-avatar" />
                <div class="bubble-wrap">
                    <div class="message-bubble">
                        <div class="bubble-text">
                    ...
                    <!-- Feedback Component -->
                    <MessageFeedback v-if="!message.typing" :content="message.content" :message-id="message.id"
                        :initial-status="message.feedbackStatus" :allow-regenerate="true"
                    ...
                    <div class="message-bubble file-bubble">
                        <div class="file-info">
                            <div class="file-icon-wrapper">
                                ...
                                <span class="file-type-text" v-if="message.fileType">
